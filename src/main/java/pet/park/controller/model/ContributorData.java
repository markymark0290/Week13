...
//Data Transfer Object (DTO) aka Plain Old Java Object (POJO) 

@Data
@NoArgsConstructor //this creates a no argument constructor
public class ContributorData {
	...
	public ContributorData(Contributor contributor) { 
		//adding this constructor removes the no argument constructor
